...
function multiply(a, b) { //eslint-disable-line
 ...
 function sumAndMultiply(a, b, c) { //eslint-disable-line
         var arr=sum(a,b);
         var summ=sum(arr[0],c);
         var arr2=multiply(a,b);
          var multi=multiply(arr2[0],c);
  /*  var arr=sum(a,b);
     var x=arr[0];
     ...
     var su=x+c;
      ...
      var y=arr2[0];
      var mu=y*c;*/
      return [summ[0],multi[0],'4 and 7 and 5 sum to 16.','The product of 4 and 7 and 5 is 140.'];
...
array where the first element is the sum of the numbers in the array, and the second 
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var arr=sum(sumArr[0],sumArr[1]);
    var x= sum(arr[0],sumArr[2]);
   
    return [x[0],"2,3,4 was passed in as an array of numbers, and 9 is their sum."];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    {
        var arr2=multiply(1,dynamicArray[x]);
        m*= arr2[0];
